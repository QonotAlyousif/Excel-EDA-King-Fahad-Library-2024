...
## Dashboard  
 **1- The first screenshot displays the dashboard with no filters or slicers applied.** 
...
<img width="1792" height="724" alt="لقطة شاشة 2026-02-11 034324" src="https://github.com/user-attachments/assets/3677c3f1-65d9-44c6-b7db-c1f275d712bc" />
 ...
 ## Excel Forumlas e.g.
1- Spliting Days from Date coulmn 
```
=TEXTSPLIT(DateCell, " ") 
```
2- Exracting quarters from date:
```
="Q"&ROUNDUP(MONTH(DateCell)/3;0)
```
3- Exracting months from date:
```
=TEXT(DateCell;"mmm")
```
