...
### Dashboard  
 - The following screenshot displays the dashboard with no filters or slicers applied. 
...
- The second screenshot display the dashboard after specific slicers have been applied
